...
export default class core
{
    ...
    {                
        ...
        this.socket = new socket(http,{cors: {origin: '*'}});
        this.log = new log();                
        ...
        {    
            ...
            if(TmpResult != '')
            {
                ...
                else
                {
                    ...
                    TmpResult = await this.getUser(TmpResult); 
            ...
            core.instance.socket.getUser('f0c73662d5c02e323e074106add205f215a890f4dfb57e56d457d47a57697f38')[0].socket.emit('msg',{msg:'selam'});
            console.log(core.instance.socket.clients('ADMIN'))
            pCallback(TmpResult);
        });
    }
    login()
