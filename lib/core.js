    ...
    connection()
    {
        if(arguments.length > 0)
        {
            return {
                ...
                connectionTimeout: typeof arguments[0].connectionTimeout == 'undefined' ? 15000 : arguments[0].connectionTimeout,
                requestTimeout: typeof arguments[0].requestTimeout == 'undefined' ? 15000 : arguments[0].requestTimeout,
                options: 
                {
        ...
        return {
            ...
            connectionTimeout: typeof this.core.config.connectionTimeout == 'undefined' ? 15000 : this.core.config.connectionTimeout,
            requestTimeout: typeof this.core.config.requestTimeout == 'undefined' ? 15000 : this.core.config.requestTimeout,
            options: 
            {
